...
void FPFNN_AnimationsEditorModule::StartupModule()
{
	...
	UE_LOG(PFNN_AnimationModuleLog, Log, TEXT("PFNNAnimationModule module has started!"));
}
...
void FPFNN_AnimationsEditorModule::ShutdownModule()
{
	...
	UE_LOG(PFNN_AnimationModuleLog, Log, TEXT("PFNNAnimationModule module has shut down"));
}
